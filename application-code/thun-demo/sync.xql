...
import module namespace config="http://www.digital-archiv.at/ns/thun-demo/config" at "modules/config.xqm";

let $target-base-default := "C:\Users\pandorfer\ownCloud\GIT\Redmine\generic-de-web-app\application-code"
